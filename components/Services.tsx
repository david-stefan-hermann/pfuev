            ...
            <Box p={4} w={"full"}>
                <SimpleGrid columns={{ base: 1, md: 3 }} spacing={10}>
                    <Feature
                        ...
                        text={
                            'Unsere umfassenden Gesundheitschecks gewährleisten, dass Ihre Pferde stets in bester Verfassung sind. \
                    ...
                    <Feature
                        ...
                        text={
                            'Mit unseren detaillierten Leistungsanalysen optimieren wir die Trainingsprogramme Ihrer Pferde. Durch \
                    ...
                    <Feature
                        ...
                        text={
                            'Unsere offiziellen Zertifizierungen bescheinigen die herausragende Qualität und Leistungsfähigkeit Ihrer Pferde. \
